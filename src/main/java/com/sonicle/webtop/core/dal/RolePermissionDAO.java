...
public class RolePermissionDAO extends BaseDAO {
	...
	public Map<Integer, ORolePermission> viewSubjectEntriesBySubjectCondition(Connection con, String subjectUid, Condition condition) throws DAOException {
		DSLContext dsl = getDSL(con);
		return dsl
			.select(
			...
			.from(ROLES_PERMISSIONS)
			.where(
				ROLES_PERMISSIONS.ROLE_UID.equal(subjectUid)
				.and(condition)
			)
			.orderBy(
				ROLES_PERMISSIONS.SERVICE_ID,
	...
	public Map<String, List<ORolePermission>> mapByServiceKeysInstanceUids(Connection con, String serviceId, Collection<String> keys, String instance, Collection<String> subjectUids) throws DAOException {
		DSLContext dsl = getDSL(con);
		
		// ROLE_UID -> SUBJECT_UID
		
		Condition subjectUidInCndt = DSL.trueCondition();
		if (subjectUids != null) {
			subjectUidInCndt = ROLES_PERMISSIONS.ROLE_UID.in(subjectUids);
		}
	...
	public static class ServiceEntry {
		public final String subjectUid;
		public final String context;
		public final String action;
		public final String instance;
		
		public ServiceEntry(String subjectUid, String context, String action, String instance) {
