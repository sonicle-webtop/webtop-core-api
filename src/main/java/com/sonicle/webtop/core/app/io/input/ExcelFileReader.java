...
import com.sonicle.webtop.core.app.io.input.excel.XlsColumnsProcessor;
import com.sonicle.webtop.core.app.io.input.excel.XlsSheetsProcessor;
import com.sonicle.webtop.core.app.io.input.excel.XlsxColumnsHandler;
...
public class ExcelFileReader extends FileRowsReader {
	...
	public ExcelFileReader(boolean binary, LogHandler logHandler) {
		super(logHandler);
		this.binary = binary;
		this.fmt = new DataFormatter();
	}
	...
	@Override
	public Map<String, String> listColumnNames(File file) throws IOException, WTReaderException {
		if (binary) {
	...
	public List<String> listSheets(File file) throws IOException, WTReaderException {
		if (binary) {
	...
	public List<String> listXlsxSheets(File file) throws IOException, WTReaderException {
	...
	public List<String> listXlsSheets(File file) throws IOException, WTReaderException {
		...
		try {
			...
			processor.process();
			return processor.getSheetNames();
	...
	public HashMap<String, String> listXlsxColumnNames(File file) throws IOException, WTReaderException {
		OPCPackage opc = null;
		...
		try {
			...
			return columnsHandler.getColumnsMapping();
	...
	public HashMap<String, String> listXlsColumnNames(File file) throws IOException, WTReaderException {
		POIFSFileSystem pfs = null;
		InputStream is = null;
	...
	public HashMap<String, Integer> listColumnIndexes(File file) throws IOException, WTReaderException {
		if(binary) {
	...
	public HashMap<String, Integer> listXlsxColumnIndexes(File file) throws IOException, WTReaderException {
		OPCPackage opc = null;
		...
		try {
			...
			return columnsHandler.getColumnIndexes();
	...
	public HashMap<String, Integer> listXlsColumnIndexes(File file) throws IOException, WTReaderException {
		POIFSFileSystem pfs = null;
		InputStream is = null;
