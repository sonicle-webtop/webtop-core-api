 ...
 * @author malbinola
 */
public class XlsxColumnsHandler extends AbstractXlsxHandler implements XSSFSheetXMLHandler.SheetContentsHandler {
	protected ColumnMapper mapper;
	protected boolean isInRange = false;
	protected LinkedHashMap<String, String> columnsMapping;
	protected HashMap<String, Integer> columnIndexes;
	...
	public HashMap<String, String> getColumnsMapping() {
