 ...
 * @author malbinola
 */
public abstract class AbstractXlsRecordsProcessor extends AbstractXlsProcessor implements HSSFListener {
	...
	public AbstractXlsRecordsProcessor(InputStream is, int headersRow, int firstDataRow, int lastDataRow, String sheetName, ColumnMapper mapper) {
		super(is);
