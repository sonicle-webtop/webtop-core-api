...
public class ResourcePermissions {
	protected final String managerSubject;
	protected final Set<String> allowedSubjects;
	
	public ResourcePermissions(String managerSubject, Set<String> allowedSubjects) {
	...
	public Set<String> getAllSubjects() {
		Set<String> set = new LinkedHashSet<>(allowedSubjects);
		if (managerSubject != null) set.add(managerSubject);
		return set;
	}
}
