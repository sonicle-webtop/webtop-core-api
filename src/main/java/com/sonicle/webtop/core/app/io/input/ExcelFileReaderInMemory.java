 ...
 * @author malbinola
 */
public class ExcelFileReaderInMemory extends FileRowsReader {
	protected boolean binary = false;
	protected String sheet = null;
	protected DataFormatter fmt = null;
	
	public ExcelFileReaderInMemory(boolean binary) {
		super(null);
		this.binary = binary;
		this.fmt = new DataFormatter();
	}
	
	public ExcelFileReaderInMemory(boolean binary, LogHandler logHandler) {
		super(logHandler);
		this.binary = binary;
		this.fmt = new DataFormatter();
	}
