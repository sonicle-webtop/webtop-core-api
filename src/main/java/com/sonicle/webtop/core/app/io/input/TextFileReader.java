...
public class TextFileReader extends FileRowsReader {
	...
	public Map<String, String> listColumnNames(InputStream is) throws IOException, WTReaderException {
	...
	public HashMap<String, Integer> listColumnIndexes(InputStream is) throws IOException, WTReaderException {
