 ...
 * @author malbinola
 */
public abstract class FileRowsReader extends AbstractReader {
	...
	public FileRowsReader() {
		super(null);
	}
	
	public FileRowsReader(LogHandler logHandler) {
		super(logHandler);
	}
	
	public abstract Map<String, String> listColumnNames(File file) throws IOException, WTReaderException;
	...
	public List<FieldMapping> listFieldMappings(File file, String[] targetFields) throws IOException, WTReaderException {
