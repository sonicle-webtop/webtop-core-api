 ...
 * @author malbinola
 */
public class CIDTokenIssued {
	private final UserProfileId profileId;
	private final String version;
	private final String clientIdentifier;
	private final String signature;
	
	public CIDTokenIssued(UserProfileId profileId, String version, String clientIdentifier, String signature) {
	...
	public static String plainSignature(final String version, final String clientIdentifier) {
		return version + "|" + clientIdentifier;
	}
}
