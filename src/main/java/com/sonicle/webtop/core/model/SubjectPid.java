 ...
 * @author malbinola
 */
public class SubjectPid {
	protected final GenericSubject.Type type;
	protected final String pid;
	
	public SubjectPid(GenericSubject.Type type, String pid) {
		this.type = Check.notNull(type, "type");
		this.pid = Check.notNull(pid, "pid");
	}
	...
	public SubjectPid(ORole orole) {
		this(GenericSubject.Type.ROLE, orole.getProfileId().toString());
	}
