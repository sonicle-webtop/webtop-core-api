...
public class PecBridgeFetcherDAO extends BaseDAO {
	...
	public List<OPecBridgeFetcher> selectAll(Connection con) throws DAOException {
		...
		return dsl
			.select(
					...
					PECBRIDGE_FETCHERS.ENABLED,
					PECBRIDGE_FETCHERS.AUTH_STATE
	...
	public int update(Connection con, OPecBridgeFetcher item) throws DAOException {
		...
		return dsl
			...
			.set(PECBRIDGE_FETCHERS.ENABLED, item.getEnabled())
			.set(PECBRIDGE_FETCHERS.AUTH_STATE, item.getAuthState())
			.where(
	...
	public int updatePasswordByWebtopProfileId(Connection con, String webtopProfileId, String password) throws DAOException {
		...
		return dsl
			.update(PECBRIDGE_FETCHERS)
			.set(PECBRIDGE_FETCHERS.PASSWORD, password)
			.set(PECBRIDGE_FETCHERS.AUTH_STATE, "UN")
			.where(
