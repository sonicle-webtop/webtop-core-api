...
public class AuditLog extends org.jooq.impl.TableImpl<com.sonicle.webtop.core.jooq.core.tables.records.AuditLogRecord> {
     ...
     */
    public final org.jooq.TableField<com.sonicle.webtop.core.jooq.core.tables.records.AuditLogRecord, java.lang.Long> AUDIT_LOG_ID = createField(org.jooq.impl.DSL.name("audit_log_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('core.seq_audit_log'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>core.audit_log.timestamp</code>.
     */
    public final org.jooq.TableField<com.sonicle.webtop.core.jooq.core.tables.records.AuditLogRecord, org.joda.time.DateTime> TIMESTAMP = createField(org.jooq.impl.DSL.name("timestamp"), org.jooq.impl.SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "", new com.sonicle.jooq.jsr310.OffsetDateTimeJodaConverter());

    /**
     * The column <code>core.audit_log.domain_id</code>.
     */
    public final org.jooq.TableField<com.sonicle.webtop.core.jooq.core.tables.records.AuditLogRecord, java.lang.String> DOMAIN_ID = createField(org.jooq.impl.DSL.name("domain_id"), org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");
     ...
     */
    public final org.jooq.TableField<com.sonicle.webtop.core.jooq.core.tables.records.AuditLogRecord, java.lang.String> CONTEXT = createField(org.jooq.impl.DSL.name("context"), org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>core.audit_log.action</code>.
     */
    public final org.jooq.TableField<com.sonicle.webtop.core.jooq.core.tables.records.AuditLogRecord, java.lang.String> ACTION = createField(org.jooq.impl.DSL.name("action"), org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "");
    ...
    private AuditLog(org.jooq.Name alias, org.jooq.Table<com.sonicle.webtop.core.jooq.core.tables.records.AuditLogRecord> aliased, org.jooq.Field<?>[] parameters) {
    ...
    public <O extends org.jooq.Record> AuditLog(org.jooq.Table<O> child, org.jooq.ForeignKey<O, com.sonicle.webtop.core.jooq.core.tables.records.AuditLogRecord> key) {
