...
public class IpGeoCache extends org.jooq.impl.TableImpl<com.sonicle.webtop.core.jooq.core.tables.records.IpGeoCacheRecord> {
     ...
     */
    public final org.jooq.TableField<com.sonicle.webtop.core.jooq.core.tables.records.IpGeoCacheRecord, java.lang.String> IP_ADDRESS = createField(org.jooq.impl.DSL.name("ip_address"), org.jooq.impl.SQLDataType.VARCHAR(45).nullable(false), this, "");

    /**
     * The column <code>core.ip_geo_cache.timestamp</code>.
     */
    public final org.jooq.TableField<com.sonicle.webtop.core.jooq.core.tables.records.IpGeoCacheRecord, org.joda.time.DateTime> TIMESTAMP = createField(org.jooq.impl.DSL.name("timestamp"), org.jooq.impl.SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "", new com.sonicle.jooq.jsr310.OffsetDateTimeJodaConverter());

    /**
     * The column <code>core.ip_geo_cache.provider</code>.
     */
    public final org.jooq.TableField<com.sonicle.webtop.core.jooq.core.tables.records.IpGeoCacheRecord, java.lang.String> PROVIDER = createField(org.jooq.impl.DSL.name("provider"), org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>core.ip_geo_cache.data</code>.
     */
    public final org.jooq.TableField<com.sonicle.webtop.core.jooq.core.tables.records.IpGeoCacheRecord, java.lang.String> DATA = createField(org.jooq.impl.DSL.name("data"), org.jooq.impl.SQLDataType.CLOB, this, "");

    private IpGeoCache(org.jooq.Name alias, org.jooq.Table<com.sonicle.webtop.core.jooq.core.tables.records.IpGeoCacheRecord> aliased) {
        this(alias, aliased, null);
    }

    private IpGeoCache(org.jooq.Name alias, org.jooq.Table<com.sonicle.webtop.core.jooq.core.tables.records.IpGeoCacheRecord> aliased, org.jooq.Field<?>[] parameters) {
    ...
    public <O extends org.jooq.Record> IpGeoCache(org.jooq.Table<O> child, org.jooq.ForeignKey<O, com.sonicle.webtop.core.jooq.core.tables.records.IpGeoCacheRecord> key) {
    ...
    public java.util.List<org.jooq.Index> getIndexes() {
        return java.util.Arrays.<org.jooq.Index>asList(com.sonicle.webtop.core.jooq.core.Indexes.IP_GEO_CACHE_AK1);
    }
