...
public class MediaTypes extends org.jooq.impl.TableImpl<com.sonicle.webtop.core.jooq.core.tables.records.MediaTypesRecord> {
     ...
     */
    public final org.jooq.TableField<com.sonicle.webtop.core.jooq.core.tables.records.MediaTypesRecord, java.lang.String> EXTENSION = createField(org.jooq.impl.DSL.name("extension"), org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>core.media_types.media_type</code>.
     */
    public final org.jooq.TableField<com.sonicle.webtop.core.jooq.core.tables.records.MediaTypesRecord, java.lang.String> MEDIA_TYPE = createField(org.jooq.impl.DSL.name("media_type"), org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    private MediaTypes(org.jooq.Name alias, org.jooq.Table<com.sonicle.webtop.core.jooq.core.tables.records.MediaTypesRecord> aliased) {
        this(alias, aliased, null);
    }

    private MediaTypes(org.jooq.Name alias, org.jooq.Table<com.sonicle.webtop.core.jooq.core.tables.records.MediaTypesRecord> aliased, org.jooq.Field<?>[] parameters) {
    ...
    public <O extends org.jooq.Record> MediaTypes(org.jooq.Table<O> child, org.jooq.ForeignKey<O, com.sonicle.webtop.core.jooq.core.tables.records.MediaTypesRecord> key) {
